...
const Introduction = () => {
  return (
    <View className="mt-12">
      ...
      <Text className="text-xl text-gray-600 leading-7 text-justify mt-7">
      ...
      <Text className="text-xl text-gray-600 mt-7 leading-7 text-justify">
      ...
      <Text className="text-3xl font-semibold mt-8 leading-7 text-justify ">Objectives</Text>
      <Text className="text-xl text-gray-600 mt-3 leading-7 text-justify">
        1. Identify the common dressmaking measuring tools and their uses in
        taking body measurements.
      </Text>
      <Text className="text-lg text-gray-600 leading-7 text-justify my-3">
        2. Perform precise measurements using the proper dressmaking measuring
        tools.
      </Text>
      <Text className="text-lg text-gray-600 leading-7 text-justify">
